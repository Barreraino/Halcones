...
INSTALL_REQUIRES = [
      'pymupdf','rasterio','numpy','matplotlib','pandas','geopandas','shapely','fiona','pyproj','descartes','osgeo','gdal','osr','ogr','os','sys','re','pathlib','setuptools','find_packages','apache-sedona'
